/// Random damage to a program's text: what an editor hands the analyzer
/// mid-keystroke. The parser recovers into a partial tree, the binder into
/// error symbols, and every rule must read both without throwing.
module CSharp.Refactor.PropertyTests.Mutation
