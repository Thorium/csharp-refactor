...
| M4 | Corpus sweep over every C# checkout under `C:\git`; category and default decisions from the counts (§5.9); CR0088 editor-only; 0.1.0, and 0.1.1 with the test suite brought toward the F# side's depth. |
